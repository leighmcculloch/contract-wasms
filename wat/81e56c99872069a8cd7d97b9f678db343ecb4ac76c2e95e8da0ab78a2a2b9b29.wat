(module
  ...
  (export "lastprice" (func 37))
  (export "publish_rate" (func 38))
  (export "set_bounds" (func 39))
  (export "set_paused" (func 40))
  (export "set_publisher" (func 41))
  ...
  (func (;21;) (type 10) (param i32 i64 i64 i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
