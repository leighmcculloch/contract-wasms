(module
  ...
  (type (;20;) (func (param i32 i32 i32 i32 i32 i32 i32) (result i64)))
  ...
  (export "set_native_fee_bp" (func 50))
  (export "set_fee_enabled" (func 54))
  (export "set_zro_fee_lib" (func 55))
  (export "withdraw_token" (func 57))
  (export "native_fee_bp" (func 58))
  (export "fee_enabled" (func 59))
  (export "zro_fee_lib" (func 60))
  (export "authorizer" (func 61))
  (export "owner" (func 62))
  (export "pending_owner" (func 63))
  (export "transfer_ownership" (func 64))
  (export "begin_ownership_transfer" (func 66))
  ...
  (func (;39;) (type 11) (param i64 i64 i64 i64) (result i64)
  ...
  (func (;87;) (type 19) (param i32 i64 i64 i64)
  ...
  (func (;88;) (type 20) (param i32 i32 i32 i32 i32 i32 i32) (result i64)
    (local i32 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\06cliver\00\00\00\00\00/25.1.0#a048a57a75762458b487052e0021ea704a926bee\00\00\00\00\00\00\00\00\06bldimg\00\00\00\00\00edocker.io/stellar/stellar-cli@sha256:c32774bfd2a57be5c2efe53195c34bcd093c799cb7087df5cdc5b2b31fa8c65f\00\00\00\00\00\00\00\00\00\00\06bldopt\00\00\00\00\000--manifest-path=message-libs/treasury/Cargo.toml\00\00\00\00\00\00\00\06bldopt\00\00\00\00\00\0a--optimize\00\00\00\00\00\00\00\00\00\06bldopt\00\00\00\00\00\12--package=treasury\00\00\00\00\00\00\00\00\00\0dsource_sha256\00\00\00\00\00\00@98536fa3af20f5bcd26588ff7d3939a0cd5a562abf17580e2403d7f74c232ec7")
)
