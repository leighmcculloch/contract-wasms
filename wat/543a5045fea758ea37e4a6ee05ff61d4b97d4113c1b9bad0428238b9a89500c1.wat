(module
  ...
  (export "set_xld_token" (func 47))
  (export "settle_auction" (func 48))
  (export "settle_auction_with_xld" (func 49))
  ...
  (func (;46;) (type 10) (param i64 i64 i64 i64) (result i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;48;) (type 5) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const -64
    i32.add
  ...
  (func (;52;) (type 21) (param i64 i64 i32)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 16
    i32.sub
