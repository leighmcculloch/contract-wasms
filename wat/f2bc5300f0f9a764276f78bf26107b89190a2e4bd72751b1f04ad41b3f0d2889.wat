(module
  ...
  (func (;46;) (type 12) (param i64 i32 i32 i32 i32)
    block ;; label = @1
      local.get 2
      local.get 4
      i32.eq
  ...
  (func (;48;) (type 14) (param i64 i64 i32)
    local.get 0
    local.get 1
    call 34
    local.get 2
  ...
  (func (;108;) (type 24) (param i32 i64 i64 i64 i64 i32)
  ...
  (func (;109;) (type 25) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      block ;; label = @2
        local.get 3
