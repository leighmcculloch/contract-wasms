  ...
  (func (;271;) (type 1) (param i32 i32) (result i32)
    ...
    block ;; label = @1
      ...
      loop ;; label = @2
        ...
        i32.const 1
        i32.shl
        i32.load16_u offset=1049960 align=1
        i32.store16 align=1
        local.get 6
        i32.const -2
        i32.add
