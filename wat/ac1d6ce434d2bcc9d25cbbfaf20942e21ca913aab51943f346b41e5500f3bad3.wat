(module
  ...
  (export "install" (func 37))
  (export "uninstall" (func 39))
  (export "_" (global 1))
  ...
  (func (;17;) (type 5) (param i64 i32 i32 i32 i32)
    block ;; label = @1
      local.get 2
      local.get 4
      i32.eq
  ...
  (func (;25;) (type 11) (param i64) (result i32)
    local.get 0
    i64.const 1
    call 13
    i64.const 1
  ...
  (func (;41;) (type 18) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
