(module
  ...
  (export "add_liquidity" (func 57))
  (export "add_rewards" (func 59))
  (export "admin" (func 60))
  (export "apply_slashing" (func 61))
  (export "bump_instance" (func 62))
  (export "claim_withdrawal" (func 63))
  ...
  (func (;90;) (type 12) (param i32 i64 i64 i32)
    (local i64)
    block ;; label = @1
      local.get 3
      i32.const 64
  ...
  (func (;94;) (type 10) (param i32 i64 i64 i64 i64)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;97;) (type 23) (param i64 i32) (result i64)
    local.get 0
    i64.const 255
    i64.and
    i64.const 77
