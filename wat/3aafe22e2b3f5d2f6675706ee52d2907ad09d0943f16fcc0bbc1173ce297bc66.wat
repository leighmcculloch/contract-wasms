(module
  ...
  (export "extend_client_info" (func 57))
  (export "extend_ttl" (func 58))
  (export "read_address_at_id" (func 59))
  (export "read_address_id" (func 60))
  (export "read_client_info" (func 61))
  (export "read_client_info_using_id" (func 62))
  (export "write_client_info" (func 63))
  (export "_" (func 65))
  ...
  (func (;26;) (type 8) (param i64 i32 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;49;) (type 19) (param i32 i64 i32 i32 i32 i32 i32)
    (local i64)
    i32.const 1048618
    i32.const 17
    call 46
  ...
  (func (;53;) (type 8) (param i64 i32 i32)
    local.get 0
    call 54
    local.get 1
    local.get 2
  ...
  (data (;0;) (i32.const 1048576) "WHITELIST_ADMINWHITELIST_OPERATORNewClientClientInfoUpdatedMaxNumberOfClientsClientIdSequenceAccessControlEventIdGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWHFwhitelisted_clientclient_id_to_addresscan_buycan_cancelcan_sellcan_transferclientidis_market_maker\00\cf\00\10\00\07\00\00\00\d6\00\10\00\0a\00\00\00\e0\00\10\00\08\00\00\00\e8\00\10\00\0c\00\00\00\f4\00\10\00\06\00\00\00\fa\00\10\00\02\00\00\00\fc\00\10\00\0f\00\00\00")
