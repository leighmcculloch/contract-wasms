(module
  ...
  (export "revoke_role" (func 62))
  (export "renounce_role" (func 64))
  (export "set_role_admin" (func 65))
  (export "remove_role_admin" (func 69))
  (export "has_role" (func 70))
  ...
  (export "set_authorized" (func 82))
  (export "clawback" (func 83))
  (export "mint" (func 84))
  (export "__constructor" (func 85))
  (export "underlying_sac" (func 89))
  (export "authorizer" (func 90))
  (export "owner" (func 91))
  (export "pending_owner" (func 92))
  (export "transfer_ownership" (func 93))
  (export "begin_ownership_transfer" (func 95))
  (export "accept_ownership" (func 100))
  (export "renounce_ownership" (func 101))
  (export "extend_instance_ttl" (func 102))
  (export "set_ttl_configs" (func 104))
  (export "ttl_configs" (func 107))
  (export "freeze_ttl_configs" (func 111))
  (export "is_ttl_configs_frozen" (func 112))
  (export "_" (global 1))
  ...
  (func (;34;) (type 18) (param i32) (result i32)
    (local i32 i64)
    local.get 0
    i64.load
    local.set 2
  ...
  (func (;36;) (type 19) (param i32 i32) (result i32)
    local.get 0
    i32.eqz
    local.get 1
    i32.eqz
  ...
  (func (;57;) (type 21) (param i64 i32 i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;58;) (type 22) (param i64 i64 i32)
    (local i32 i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;99;) (type 10) (param i32 i64 i64)
    local.get 0
    call 46
    local.get 1
    local.get 2
  ...
  (func (;114;) (type 10) (param i32 i64 i64)
    (local i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;123;) (type 26) (param i64 i64 i64 i64 i32 i32) (result i64)
    (local i32 i32 i32 i64)
    global.get 0
    i32.const -64
    i32.add
