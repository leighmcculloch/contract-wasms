(module
  ...
  (import "c" "0" (func (;18;) (type 4)))
  (import "b" "8" (func (;19;) (type 1)))
  (import "b" "6" (func (;20;) (type 0)))
  (import "c" "_" (func (;21;) (type 1)))
  ...
  (export "add_signer" (func 114))
  (export "get_signer" (func 115))
  (export "remove_signer" (func 120))
  (export "update_signer" (func 121))
  ...
  (func (;66;) (type 25) (param i32 i64 i64) (result i32)
  ...
  (func (;70;) (type 26) (param i64 i64 i64 i64) (result i32)
    local.get 0
    local.get 2
    i64.eq
    if (result i32) ;; label = @1
  ...
  (func (;77;) (type 29) (param i64 i64 i64)
    local.get 0
    local.get 1
    local.get 2
    call 32
  ...
  (func (;80;) (type 30) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;83;) (type 31) (param i32 i32 i32 i32) (result i32)
    local.get 1
    local.get 3
    i32.eq
    if (result i32) ;; label = @1
  ...
  (func (;94;) (type 14) (param i32 i32 i32 i32)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;104;) (type 16) (param i64 i32)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;125;) (type 18) (param i32 i32 i32) (result i32)
    (local i32 i32 i32)
    block ;; label = @1
      local.get 2
      i32.eqz
  ...
  (func (;127;) (type 18) (param i32 i32 i32) (result i32)
  ...
  (func (;129;) (type 7) (param i32 i64 i64)
    (local i64)
    i64.const 1
    local.set 3
    block ;; label = @1
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\06binver\00\00\00\00\00\051.0.0\00\00\00\00\00\00\00\00\00\00\05rsver\00\00\00\00\00\00\061.94.0\00\00\00\00\00\00\00\00\00\08rssdkver\00\00\00/27.0.0#e5cb4b52c3da8e56fc48adfd7b85d85976c1a059\00")
