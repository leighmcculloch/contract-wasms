(module
  ...
  (export "set_routing_addresses" (func 46))
  ...
  (func (;36;) (type 19) (param i32 i32 i32 i32) (result i64)
    local.get 1
    local.get 3
    i32.ne
    if ;; label = @1
  ...
  (func (;43;) (type 20) (param i64 i64 i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 96
    i32.sub
  ...
  (func (;52;) (type 22) (param i64 i64 i32)
    (local i32 i64 i64)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (data (;0;) (i32.const 1048576) "ContractAdminMarketplaceSealedBidVaultAquariusUstryTokenXldTokenbuy_from_routerbuy_nft_from_routersettle_from_routerswap_chainedtransferpublic_deposit_forargscontractfn_name\00\00\00\9a\00\10\00\04\00\00\00\9e\00\10\00\08\00\00\00\a6\00\10\00\07\00\00\00contextsub_invocations\00\00\c8\00\10\00\07\00\00\00\cf\00\10\00\0f")
