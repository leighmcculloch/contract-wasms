(module
  ...
  (export "public_buy_nft_with_xld" (func 49))
  (export "public_buy_with_xld" (func 50))
  (export "set_routing_addresses" (func 51))
  (export "set_xld_token" (func 52))
  (export "settle_auction" (func 53))
  (export "settle_auction_with_xld" (func 54))
  ...
  (func (;53;) (type 5) (param i64 i64 i64 i64 i64 i64 i64) (result i64)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 80
    i32.sub
  ...
  (func (;57;) (type 23) (param i64 i64 i32)
    (local i32 i32 i64 i64 i64)
    global.get 0
    i32.const 16
    i32.sub
