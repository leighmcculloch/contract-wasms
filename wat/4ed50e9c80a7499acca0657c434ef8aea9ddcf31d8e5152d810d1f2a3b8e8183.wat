(module
  ...
  (type (;16;) (func (param i32 i32 i32 i64 i64)))
  ...
  (export "set_price" (func 70))
  (export "set_price_for_arbitrum" (func 74))
  (export "set_native_token_price_usd" (func 75))
  (export "is_price_updater" (func 76))
  (export "arbitrum_compression_percent" (func 78))
  (export "arbitrum_price_ext" (func 80))
  (export "eid_to_model_type" (func 82))
  (export "estimate_fee_by_eid" (func 88))
  (export "native_token_price_usd" (func 91))
  (export "get_price" (func 92))
  (export "get_price_ratio_denominator" (func 93))
  (export "__constructor" (func 94))
  (export "upgrade" (func 98))
  (export "migrate" (func 100))
  ...
  (func (;44;) (type 20) (param i32 i32) (result i32)
    local.get 0
    i32.eqz
    local.get 1
    i32.eqz
  ...
  (func (;55;) (type 21) (param i64 i32) (result i64)
    (local i32)
    global.get 0
    i32.const 32
    i32.sub
  ...
  (func (;84;) (type 16) (param i32 i32 i32 i64 i64)
  ...
  (func (;87;) (type 16) (param i32 i32 i32 i64 i64)
    (local i32 i32 i32 i64 i64 i64 i64)
    global.get 0
    i32.const 272
    i32.sub
  ...
  (func (;121;) (type 15) (param i32 i32) (result i64)
    local.get 0
    i64.extend_i32_u
    i64.const 32
    i64.shl
  ...
  (func (;131;) (type 18) (param i32 i64 i64 i64 i64)
  ...
  (func (;133;) (type 27) (param i32 i64 i32)
    (local i32 i64)
    global.get 0
    i32.const 48
    i32.sub
  ...
  (@custom "contractmetav0" (after data) "\00\00\00\00\00\00\00\06cliver\00\00\00\00\00/25.1.0#a048a57a75762458b487052e0021ea704a926bee\00\00\00\00\00\00\00\00\06bldimg\00\00\00\00\00edocker.io/stellar/stellar-cli@sha256:c32774bfd2a57be5c2efe53195c34bcd093c799cb7087df5cdc5b2b31fa8c65f\00\00\00\00\00\00\00\00\00\00\06bldopt\00\00\00\00\00---manifest-path=workers/price-feed/Cargo.toml\00\00\00\00\00\00\00\00\00\00\06bldopt\00\00\00\00\00\0a--optimize\00\00\00\00\00\00\00\00\00\06bldopt\00\00\00\00\00\14--package=price-feed\00\00\00\00\00\00\00\0dsource_sha256\00\00\00\00\00\00@98536fa3af20f5bcd26588ff7d3939a0cd5a562abf17580e2403d7f74c232ec7")
)
