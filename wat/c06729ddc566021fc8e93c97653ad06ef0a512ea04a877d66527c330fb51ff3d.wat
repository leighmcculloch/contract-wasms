(module
  ...
  (global (;1;) i32 i32.const 1048787)
  (global (;2;) i32 i32.const 1049148)
  (global (;3;) i32 i32.const 1049152)
  (export "memory" (memory 0))
  (export "enforce" (func 38))
  (export "get_session" (func 43))
  (export "install" (func 44))
  (export "is_active" (func 45))
  (export "revoke" (func 46))
  (export "uninstall" (func 47))
  (export "_" (global 1))
  ...
  (func (;20;) (type 5) (param i32 i32)
    ...
    local.set 3
    i32.const 0
    i32.load8_u offset=1048944
    drop
    i32.const 0
    i32.load8_u offset=1048916
    drop
    i32.const 0
    i32.load8_u offset=1048930
    drop
    local.get 1
    i64.load
    local.set 4
  ...
  (func (;21;) (type 6) (param i64 i32 i32 i32 i32)
    block ;; label = @1
      local.get 2
      local.get 4
      i32.eq
  ...
  (func (;23;) (type 7) (param i64 i32) (result i64)
    local.get 0
    local.get 1
    i32.const 3
    call 50
  ...
  (func (;27;) (type 11) (param i32 i64 i32)
  ...
  (func (;32;) (type 11) (param i32 i64 i32)
    (local i32)
    global.get 0
    i32.const 64
    i32.sub
  ...
  (func (;41;) (type 20) (param i64 i64) (result i32)
    (local i32 i32 i32)
    global.get 0
    i32.const 16
    i32.sub
  ...
  (func (;50;) (type 23) (param i64 i32 i32) (result i64)
    local.get 0
    local.get 1
    i64.extend_i32_u
    i64.const 32
  ...
  (func (;51;) (type 24) (param i32 i32 i32) (result i32)
